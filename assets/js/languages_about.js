...
Summary : "ملخص مهني",
Summary_Data : "مطور ويب يتمتع بشغف عالٍ وتركيز دقيق على التفاصيل، متخصص في تصميم وتطوير وصيانة مواقع وتطبيقات الويب الحديثة والديناميكية. أتقن  HTML5، CSS3، وJavaScript لبناء واجهات مستخدم سريعة الاستجابة وذات أداء عالٍ. وللواجهة الخلفية، لدي إجادة في PHP و SQL مع خبرة عملية  في استخدام إطار عمل Laravel لتسريع عملية التطوير وتقديم حلول قوية وقابلة للتوسع. أطبق مبادئ البرمجة الشيئية (OOP) لضمان كتابة شفرة نظيفة وقابلة للصيانة، وملتزم بتحسين أداء التطبيقات والمواكبة المستمرة لأحدث التقنيات.",
Exp_Years : " خبرة أكثر من سنتين",
Bachelor : "ليسانس آداب - جامعة القاهرة",
