...
Skills : "المهارات",
JavaScript : "Javascript",
JavaScript_Skill : "بناء واجهات أمامية (Front-End) تفاعلية وديناميكية وتنفيذ المنطق البرمجي من جانب العميل.",
JQuery : "Jquery",
...
API : "API",
API_Skill : "بناء موصلات بيانات قوية (واجهات برمجة التطبيقات - APIs) لتمكين تفاعل سلس وموثوق به بين الأنظمة المختلفة.",
WordPress : "Wordpress",
...
Work_Company2_2 : "بناء وإطلاق حلول ويب قوية وآمنة، مهندسة لتخصيصها وفقاً لمتطلبات العميل المحددة.",
